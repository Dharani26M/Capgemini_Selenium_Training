...
public class ScrollingInto_View_Method {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		js.executeScript("arguments[0].scrollIntoView()",driver.findElement(By.xpath("//span[contains(.,'Shorts')]")));
		js.executeScript("arguments[0].scrollIntoView(false)",driver.findElement(By.xpath("//span[contains(.,'Shorts')]")));
	}
