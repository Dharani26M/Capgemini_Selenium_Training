...
public class Learning_Selection_Methods {
...
//		s.selectByValue("3");
		s.selectByContainsVisibleText("Pur");
//		s.selectByVisibleText("Purple");
//		s.selectByIndex(0);
		System.out.println(s.isMultiple());
		
//		s.deselectByIndex(0); // deselect will not work in single dropdown , gives "UnsupportOperationException"
		driver.quit();
