...
public class AutoHealingTestCase {
	WebDriver driver;
	...
	public void practice() throws IOException {
		...
		FileInputStream fls=new FileInputStream("./src/test/resources/orangehrm.commondata/common.properties");
		...
		login.click();
		driver.quit();
		FileOutputStream fos=new FileOutputStream("./src/test/resources/orangehrm.commondata/common.properties");
